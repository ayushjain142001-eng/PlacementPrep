...
class QuestionBank:
    ...
    REASONING_QUESTIONS = [
        ...
        {"category": "visual", "title": "Mirror Image", "description": "Which is the mirror image of 'SMART'?", "difficulty": "medium", "options": ["TRAMS", "SMART", "TRAMs", "STRAM"], "correct_answer": "TRAMS", "points": 15, "time_limit": 75},
